...
// function checkArray(setOfNumbers) {
//   let collection = 0;
//   for (let i = 0; i < resultOfNumber.length; i++) {
//     let number = setOfNumbers[i];
//     if (number > 5) {
//       console.log(number[i], "will be added");
//       collection += number
//     } else if {
//       console.log(number[i], "will not be added");
//     }
//   }
//   return collection;
// }
// console.log(checkArray(8));
